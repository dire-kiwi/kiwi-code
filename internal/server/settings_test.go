...
func TestSettingsAPIUpdatesCodingAgents(t *testing.T) {
	...
	if len(settings.CodingAgents) != 7 || settings.CodingAgents[0].Kind != project.CodingAgentKindPiNative ||
		...
		settings.CodingAgents[5].Kind != project.CodingAgentKindCodexNative || settings.CodingAgents[6].Kind != project.CodingAgentKindGrok {

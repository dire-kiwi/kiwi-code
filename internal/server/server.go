...
func NewWithOptions(projects *project.Store, options Options) (http.Handler, error) {
	...
	mux.HandleFunc("PUT /api/projects/{id}/threads/{threadId}/agents/{agent}/activity", server.updateAgentScopedActivity)
	mux.HandleFunc("DELETE /api/projects/{id}/threads/{threadId}/agents/{agent}/activity", server.acknowledgeAgentScopedActivity)
	...
	mux.HandleFunc("GET /api/projects/{id}/threads/{threadId}/agents/{agent}/native", server.terminal.serveAgentNative)
